...
const TicketCard = ({
	...
	return <div className='text-left w-[90vw] md:w-[35vw] border-black border rounded-[8px] px-4 py-7 hover:scale-105 transform duration-75 overflow-hidden bg-white'>
		...
		<div className='flex items-center gap-5'>
			...
			<p className='text-xl inline-flex gap-2 cursor-pointer border border-black py-3 px-5 rounded ' onClick={showPopup}>
				<span>
		...
		<main className='mb-5 our-journey p-custom font-thunder font-bold '>
			...
			<div className='get-tickets mt-[10vh]'>
				...
				<div className='flex flex-col md:flex-wrap items-center gap-10 md:flex-row justify-start py-5'>
					<TicketCard popupTitleSetter={setPopupTitle} popupMessageSetter={() => setPopupMessage(EARLY_CUSAT_POPUP_MSG)} popupHandler={setShowPopup} redirect="/ticket/book?type=earlycusatian" price="700" type="EARLY BIRD CUSAT STUDENTS" popupMessage={EARLY_CUSAT_POPUP_MSG} />
					<TicketCard popupTitleSetter={setPopupTitle} popupMessageSetter={() => setPopupMessage(EARLY_REG_POPUP_MSG)} popupHandler={setShowPopup} redirect="/ticket/book?type=earlyregular" price="900" type="EARLY BIRD REGULAR" popupMessage={EARLY_REG_POPUP_MSG} />
					<TicketCard popupTitleSetter={setPopupTitle} popupMessageSetter={() => setPopupMessage(CUSAT_POPUP_MSG)} popupHandler={setShowPopup} redirect="/ticket/book?type=cusatian" price="800" type="CUSAT STUDENTS" popupMessage={CUSAT_POPUP_MSG} />
					<TicketCard popupTitleSetter={setPopupTitle} popupMessageSetter={() => setPopupMessage(REG_POPUP_MSG)} popupHandler={setShowPopup} redirect="/ticket/book?type=regular" price="1000" type="REGULAR" popupMessage={REG_POPUP_MSG} />
				</div>
			</div>
			<FAQSection />
		</main>
