		...
		<footer>
			<div className="flex flex-col gap-5 py-5 ">
				...
				<div className='flex flex-col md:flex-row gap-3 md:gap-10 p-custom md:items-end'>
					<div className='h-96 rounded-[6px] md:rounded-15 overflow-hidden flex-1 border-2 border-black bg-black text-white p-7 flex flex-col justify-between'>
						<p className='text-4xl md:text-5xl font-thunder font-extrabold uppercase tracking-normal '>HAVE ANY QUESTIONS ?</p>
						<p className='text-5xl md:text-6xl font-thunder font-bold'>CONTACT US</p>
						<div>
							<p className='text-xl md:text-2xl font-Helvetica font-bold'>IVINE JOJU</p>
							<p className='text-lg md:text-xl font-Helvetica font-bold'>TEDX CUSAT ORGANIZER</p>
							<p className='text-lg md:text-xl font-Helvetica font-bold'>+91 1234 567 890</p>
						</div>
						<div>
							<p className='text-xl md:text-2xl font-Helvetica font-bold'>Akshay</p>
							<p className='text-lg md:text-xl font-Helvetica font-bold'>TEDX CUSAT ORGANIZER</p>
							<p className='text-lg md:text-xl font-Helvetica font-bold'>+91 1234 567 890</p>
						</div>
					</div>
					<div className='h-96 rounded-[6px] md:rounded-15 overflow-hidden flex-1 border-2 border-black p-7'>
					...
					<div className='rounded-[6px] md:rounded-15 overflow-hidden flex-1 border-2 border-black'>
						<iframe
