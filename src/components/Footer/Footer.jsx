...
const Footer = () => {
	...
	width="450" height="400" style={{border:"15px"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" className='rounded-15 mt-10 border-2 border-black w-9/10 md:w-1/4'></iframe>
			</div>
		</footer>
	);
}
