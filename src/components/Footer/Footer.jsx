		...
		<footer>
			<div className="flex flex-col gap-5 py-5 ">
				...
				<div className='flex flex-col md:flex-row gap-3 md:gap-10 p-custom md:items-end'>
					<div className='h-96 rounded-[6px] md:rounded-15 overflow-hidden flex-1 border-2 border-black bg-black text-white p-7 flex flex-col justify-between order-2 md:order-1'>
					...
					<div className='h-96 rounded-[6px] md:rounded-15 overflow-hidden flex-1 border-2 border-black p-7 bg-white order-3 md:order-2'>
					...
					<div className='rounded-[6px] md:rounded-15 overflow-hidden flex-1 border-2 border-black order-1 md:order-3'>
						<iframe
