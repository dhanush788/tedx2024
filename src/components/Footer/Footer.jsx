		...
		<footer>
			<div className="flex flex-col gap-5 py-5 ">
				...
				<div className='flex flex-col md:flex-row gap-3 md:gap-10 p-custom md:items-end'>
					<div className='rounded-[6px] md:rounded-15 overflow-hidden flex-1 md:order-1 order-2 border-2 border-black'>
						<iframe
					...
					<div className='flex flex-col items-center py-5 md:py-0 flex-1 md:order-2 order-1'>
						<p className='text-3xl font-semibold font-thunder !leading-none uppercase'>Contact <span className='text-[#EB0028]'>US</span></p>
						<div className='grid grid-cols-2 w-full py-5 gap-5'>
						...
						<a href='mailto:organizertedxcusat.in'>
							<div className='flex bg-[#EB0028] py-4 px-9 rounded-[6px] md:rounded-2xl text-white font-avenue md:text-2xl'>organizer@tedxcusat.in</div>
						</a>
					</div>
					<div className='grid grid-cols-2 flex-1 order-3'>
						...
						<div className='flex flex-col md:flex-col-reverse items-end gap-4'>
							...
							<div className='flex flex-col md:flex-col-reverse items-end'>
