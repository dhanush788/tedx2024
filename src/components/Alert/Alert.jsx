    ...
    return (
        open && (
            <>
                ...
                <div className="fixed bottom-3 left-[50%] md:left-[66%] -translate-x-[50%] md:-translate-x-5 md:bottom-10 md:right-10 z-[100] w-[90vw] md:w-1/3  font-HelveticaLight">
                    <div className="flex flex-col-reverse md:flex-row bg-[#EBEBEB] border-2 border-black rounded-xl md:rounded-2xl overflow-hidden">
                        <div className='flex flex-col my-auto flex-1 relative justify-center items-center px-8 pr-14 md:pr-20 py-10' >
                            ...
                            <div className='w-full flex flex-col gap-3 relative'>
                                <p className=' text-xl md:text-3xl capitalize text-tedRed font-bold !font-Helvetica'>Buy our merchantise now!</p>
