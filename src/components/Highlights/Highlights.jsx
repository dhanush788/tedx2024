...
const Highlights = () => {
  ...
  return (
    <div className="ml-[122px] my-16 w-[1350px] h-[431px]">
      <div 
      ...
      >
        <div 
          ref={sliderRef}
          className="absolute flex h-full transition-transform duration-300 ease-out"
        >
          {/* Text Section */}
          <div className="flex-shrink-0 h-full w-[600px] flex flex-col justify-center pr-4">
            <h1 className="font-Helvetica text-[56px] leading-tight font-extrabold">
          ...
          <div className="flex-shrink-0 h-full w-[430px] flex flex-col justify-center ml-6 mr-3">
            <p className="text-base font-light uppercase ">
            ...
            <div className="flex-shrink-0 relative w-[430px] h-[287px]">
            <img
              src="3.svg"
              alt="Event Photo"
              className="absolute top-[36px] w-[430px] h-[287px] object-cover rounded-[15px] border border-gray-200"
              draggable="false"
            />
          </div>
          </div>
          {/* Text Section and Fourth Image */}
          <div className="flex-shrink-0 h-full w-[381px] flex flex-col justify-center mx-3">
            <div className="flex-shrink-0 relative w-[381px] h-[253px]">
              <img
                src="4.svg"
                alt="Event Photo"
                className="absolute bottom-[42px] w-[381px] h-[253px] object-cover rounded-[15px] border border-gray-200"
                draggable="false"
              />
              </div>
            <p className="text-base font-light uppercase ">
          ...
          <div className="flex-shrink-0 h-full flex flex-col w-[430px] justify-center mx-3">
            <p className="text-base font-light uppercase ">
            ...
            <div className="flex-shrink-0 relative w-[430px] h-[242px]">
            <img
              src="5.svg"
              alt="Event Photo"
              className="absolute top-[48px] w-[430px] h-[242px] object-cover rounded-[15px] border border-gray-200"
              draggable="false"
            />
          </div>
          </div>
          {/* Sixth Image */}
          <div className="flex-shrink-0 relative w-[242px] h-[430px] mx-3">
            <img
              src="6.svg"
              alt="Event Photo"
          ...
          <div className="flex-shrink-0 h-full w-[430px] flex flex-col justify-center mx-3">
            <div className="flex-shrink-0 relative w-[430px] h-[286px]">
              <img
                src="7.svg"
                alt="Event Photo"
                className="absolute bottom-[36px] w-[430px] h-[286px] object-cover rounded-[15px] border border-gray-200"
                draggable="false"
              />
              </div>
            <p className="text-base font-light uppercase">
          ...
          {/* Nineth Image */}
          <div className="flex-shrink-0 h-full flex flex-col  w-[394px] justify-center mx-3">
            <div className="flex-shrink-0 relative w-[394px] h-[253px]">
              <img
                src="9.svg"
                alt="Event Photo"
                className="absolute bottom-[42px] w-[394px] h-[253px] object-cover rounded-[15px] border border-gray-200"
                draggable="false"
              />
              </div>
            <p className="text-base font-light uppercase pr-8">
          ...
          {/* Tenth Image */}
          <div className="flex-shrink-0 relative w-[287px] h-[430px] mx-3">
            <img
              src="10.svg"
              alt="Event Photo"
              className="absolute w-[287px] h-[430px] object-cover rounded-[15px] border border-gray-200"
          ...
          <span className='text-tedRed font-Helvetica font-black'>Hani Mustafa </span>
            ...
            <div className="flex-shrink-0 relative w-[430px] h-[274px]">
            <img
              src="11.svg"
              alt="Event Photo"
              className="absolute top-[28px] w-[430px] h-[274px] object-cover rounded-[15px] border border-gray-200"
              draggable="false"
            />
          </div>
          </div>
